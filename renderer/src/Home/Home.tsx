...
const Home = (props: Props) => {
	...
	const time = new Date();
	time.setSeconds(time.getSeconds() + parseInt(localStorage.getItem('workDuration') || '50') * 60);
	...
	return (
		<Container>
			<Center>
				<Button leftIcon={<Settings />} mt='lg' mb='md' size='xs' onClick={() => navigate('/configure')}>
					Configure
				</Button>
			</Center>
